      ...
      <section className="wrapper_section">
        <div className="feedback_banner_container">
          ...
          <div className="feedback_content">
            ...
            <p>
              Feedback from Noted Personalities
            </p>
          </div>
        </div>
      </section>
...
<section className="wrapper_section">
  <div className="feedback_list_container">
    {/* Top Left - Full height card */}
    <div className="feedback_card card_1">
      <p className="feedback_text">
        Our locality, Jammu and Kashmir is a challenging hilly region, where reaching to remote communities is difficult. Economically and educationally, these areas remain underdeveloped. So, here comes the importance of organizations which can satisfy the needs of people. VTS India Foundation is one of such organizations which proved very successful in our region. I have seen for the last 15 years, they have made successful interventions in the system as guest in the title, the principal and professor of Degree College Poonch. So, their main focus is to remain on the dimension of creating scientific temperament towards the promotion of different culture and civilizations here. My opinion about this organization is that it has done a wonderful job in this challenging area.
      </p>
      <div className="feedback_author">
        <p className="author_name">Prof. Seyd Musarath HussainShah</p>
        <p className="author_title">Principal Govt. Degree College Mandi</p>
      </div>
    </div>

    {/* Top Right - Medium card */}
    <div className="feedback_card card_2">
      <p className="feedback_text">
        Our locality, Jammu and Kashmir is a challenging hilly region, where reaching to remote communities is difficult. Economically and educationally, these areas remain underdeveloped. So, here comes the importance of organizations which can satisfy the needs of people. VTS India Foundation is one of such organizations which proved very successful in our region. I have seen for the last 15 years, they have made successful interventions in the system. I have been invited in many programs as guest in the title, the principal and professor of
      </p>
      <div className="feedback_author">
        <p className="author_name">Prof. Seyd Musarath</p>
        <p className="author_title">Principal Govt. Degree College</p>
      </div>
    </div>

    {/* Bottom Right - Shorter card */}
    <div className="feedback_card card_3">
      <p className="feedback_text">
        Our locality, Jammu and Kashmir is a challenging hilly region, where reaching to remote communities is difficult. Economically and educationally, these areas remain underdeveloped. So, here comes the importance of organizations which can satisfy the needs of people. VTS India Foundation is one of such organizations which proved very successful in our region.
      </p>
      <div className="feedback_author">
        <p className="author_name">Prof. Seyd Musarath HussainShah</p>
        <p className="author_title">Principal Govt. Degree College Mandi</p>
