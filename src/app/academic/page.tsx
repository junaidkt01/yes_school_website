...
const [chartData, setChartData] = useState<SchoolData[]>([]);
  ...
  // 3. Define Mobile Styles Config
  // This keeps the JSX clean and easy to tweak
  const chartConfig = {
    barSize: isMobile ? 12 : 22,
    fontSize: isMobile ? 10 : 12,
    margin: isMobile
      ? { top: 30, right: 10, left: -20, bottom: 0 }
      : { top: 40, right: 30, left: 0, bottom: 10 },
    height: isMobile ? 300 : 400, // Slightly shorter on mobile to fit view
  };
...
<div>
      ...
      <div className="school_target_container">
        ...
        >
          {/* 100% Width ensures it fills the container in both desktop and mobile */}
          <ResponsiveContainer width="100%" height={chartConfig.height}>
            <BarChart data={chartData} margin={chartConfig.margin}>
              ...
              <XAxis
                dataKey="year"
                tick={{ fill: "#000000", fontSize: chartConfig.fontSize }}
              />
              <YAxis
                tick={{ fill: "#000000", fontSize: chartConfig.fontSize }}
                domain={[0, 1000]}
              ...
              {/* Bars with Dynamic barSize and Label FontSize */}
              <Bar
                dataKey="A"
                fill="#FEE3C5"
